# blazor-notes
> [!NOTE]
> This is a collection of notes about Blazor I have taken while reading other resources. The purpose of this `readme` is simply to consolidate them into a single page for my own reference.
>
